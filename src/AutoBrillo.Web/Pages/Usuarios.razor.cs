...
public partial class Usuarios
{
    ...
    {
        if (string.IsNullOrWhiteSpace(edicion.Nombre) || edicion.Id_Roles == 0 || (edicion.Id_Usuarios == 0 && string.IsNullOrWhiteSpace(edicion.Password)))
        { mensaje = "Completá nombre, contraseña y rol."; return; }
